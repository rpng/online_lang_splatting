...
def process_single_eval(feat_dir, eval_index, image_path, image_shape, 
                        clip_model, model, model_online, gt_ann, output_path, 
    ...
    with torch.no_grad():
        ...
        reshaped_sem_feat_15 = F.interpolate(sem_feat.permute(0, 3, 1, 2), size=(new_h, new_w), mode='bilinear', align_corners=False).permute(0, 2, 3, 1)
...
@torch.no_grad()
def evaluate_per_image(feat_dir, output_path, ae_ckpt_path, online_ckpt_path, json_folder, mask_thresh, 
    ...
    for eval_index in tqdm(eval_index_list):
        ...
        mean_iou_chosen, acc = process_single_eval(feat_dir, eval_index, image_paths[counter], image_shape, 
                                                   clip_model, model, model_online, gt_ann, output_path, mask_thresh, 
                                                   colormap_options, logger, device, code_size=code_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ae_ckpt_dir", type=str, default=
                        "/home/saimouli/Downloads/training_weights_general/epoch=149-step=16500.ckpt")
    parser.add_argument("--online_ae_ckpt", type=str, 
    ...
    evaluate_per_image(feat_dir, output_path, ae_ckpt_path, online_ckpt_path, label_folder, mask_thresh,
